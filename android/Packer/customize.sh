#/usr/bin/sh
# ELF Kernel A-Only Installer
# By KeJia

ui_print " "
ui_print "- Install ELF Kernel"
ui_print " "

if test -z '$(grep mido /system/build.prop)';
then 
  ui_print "- Device is not ' Redmi Note 4X ' , cannot install this kernel."
  exit 1
fi
